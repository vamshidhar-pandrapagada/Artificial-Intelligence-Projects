...
def main():
    ...
    test_agents = [
        Agent(AlphaBetaPlayer(score_fn=improved_score), "ID_Improved"),
        Agent(AlphaBetaPlayer(score_fn=custom_score), "Student_1"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_2), "Student_2"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_3), "Student_3")
    ]
